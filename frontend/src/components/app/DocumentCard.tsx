...
const DocumentCard = ({ id, title, date, pages, thumbnail, onDelete }: DocumentCardProps) => {
        ...
        <Link to={`/chat/${id}`}>
          <div className="relative pt-[65%] bg-gray-100 dark:bg-gray-800">
            ...
            {isHovered && (
              ...
              >
                <span className="text-white font-medium px-3 py-1.5 rounded-full bg-primary/90">
                  Chat
                </span>
              </motion.div>
            )}
